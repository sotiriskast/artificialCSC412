        ...
        <v-col>
          <v-row no-gutters>
            <v-col cols="12" sm="7" class="text-center">
              ...
              <p>
                Future applications are expected to bring about enormous
                changes, but AI is already present in our everyday lives.
              </p>
            </v-col>
            <v-col align-self="center" cols="12" sm="5" class="text-center">
              <nuxt-link to="/about">
                <v-btn x-large color="primary" rounded>Read More</v-btn>
              </nuxt-link>
            </v-col>
          </v-row>
        </v-col>
