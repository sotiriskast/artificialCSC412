    ...
    <v-container>
      <v-row>
        <v-col cols="12" md="5" class="py-12"
          ><v-row no-gutters>
            <v-col cols="12">
              <v-link>ARTIFICIAL Intelligence</v-link>
            </v-col>
            <v-col cols="12">
              ...
              <v-list two-line class="transparent">
                <v-list-item>
                  ...
                  <v-list-item-content>
                    ...
                    <v-list-item-subtitle
                      >1400 Main Street, Larnaca, LC 12345</v-list-item-subtitle
                    >
                  </v-list-item-content>
                </v-list-item>
                <v-divider></v-divider>
                ...
                <v-list-item>
                  ...
                  <v-list-item-content>
                    ...
                    <v-list-item-subtitle>(357) 555-6789</v-list-item-subtitle>
                    <v-list-item-subtitle>(357) 555-1234</v-list-item-subtitle>
                  </v-list-item-content>
                </v-list-item>
                <v-divider></v-divider>
              </v-list>
  ...
  data() {
    return {
      social: [
        ...
        {
          platform: 'Github',
          link: 'https://github.com/sotiriskast/',
          icon: 'mdi-github',
        },
      ],
    }
